...
public class AuthController {
    ...
    public ResponseEntity<?> signup(@RequestBody AuthDto.SignUpRequest signUpRequest) {
        ...
        return ResponseEntity.ok(ApiUtils.success(authService.login(new AuthDto.LoginRequest(signUpRequest.getEmail(), signUpRequest.getPassword()))));
    }
    ...
    public ResponseEntity<?> login(@RequestBody AuthDto.LoginRequest loginRequest) {
        return ResponseEntity.ok(ApiUtils.success(authService.login(loginRequest)));
    }
